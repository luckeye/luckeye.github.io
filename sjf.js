...
["dart.dom.html", "dart:html", , W, {
  ...
  Element: {
    "^": "Node;className%,id=,style=,nextElementSibling=,previousElementSibling=",
  ...
  CssStyleDeclarationBase: {
    "^": "Object;",
    set$borderBottomColor: function(receiver, value) {
      this.setProperty$3(receiver, "border-bottom-color", value, "");
    },
    set$borderLeftColor: function(receiver, value) {
      this.setProperty$3(receiver, "border-left-color", value, "");
    },
    set$borderRightColor: function(receiver, value) {
      this.setProperty$3(receiver, "border-right-color", value, "");
    },
    ...
    set$flexFlow: function(receiver, value) {
      this.setProperty$3(receiver, "flex-flow", value, "");
    },
    get$height: function(receiver) {
...
["", "sjf.dart", , B, {
  ...
  main: [function() {
    var t1, text, text_area_view, clear_data_view, change_prev, change_next, change_use_store, change_use_product, change_close;
    $.space_click_count = 0;
    ...
    $.urgent_num = 0;
    $.label_num = 0;
    $.urgents = P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, P.$int);
    ...
    $.urgent_num_e = document.querySelector("#urgent_num");
    $.label_num_e = document.querySelector("#label_num");
    $.divs_list = H.setRuntimeTypeInfo([], [B.Divs]);
    t1 = document.querySelector("#top");
    $.top_view = t1;
    $.body_view = t1.parentElement;
    t1.className = "top";
    ...
    $.data_view = t1;
    t1.className = "full_screen";
    J.set$flexFlow$x(t1.style, "column");
    text_area_view = document.createElement("textarea", null);
    J.set$flex$x(text_area_view.style, "1");
    clear_data_view = document.createElement("button", null);
    clear_data_view.textContent = "\u6e05\u9664";
    J.set$height$x(clear_data_view.style, "6em");
    t1 = J.get$onClick$x(clear_data_view);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(B.onClearData$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    $.data_view.appendChild(text_area_view);
    $.data_view.appendChild(clear_data_view);
    ...
    $.body_view.appendChild($.data_view);
    t1 = document.querySelector("#bottom");
    $.bottom_view = t1;
    t1.className = "bottom";
    J.set$display$x(t1.style, "flex");
    t1 = document.querySelector("#change");
    $.change_view = t1;
    t1.className = "bottom";
    J.set$flexFlow$x(t1.style, "row");
    change_prev = document.createElement("button", null);
    change_prev.textContent = "\u524d\u4e00\u4e2a";
    t1 = J.get$onClick$x(change_prev);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(B.onChangePrev$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    change_next = document.createElement("button", null);
    change_next.textContent = "\u540e\u4e00\u4e2a";
    t1 = J.get$onClick$x(change_next);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(B.onChangeNext$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    change_use_store = document.createElement("button", null);
    change_use_store.textContent = "\u4f7f\u7528\u5546\u5e97";
    t1 = J.get$onClick$x(change_use_store);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(B.onChangeUseStore$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    change_use_product = document.createElement("button", null);
    change_use_product.textContent = "\u4f7f\u7528\u5546\u54c1";
    t1 = J.get$onClick$x(change_use_product);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(B.onChangeUseProduct$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    change_close = document.createElement("button", null);
    change_close.textContent = "\u9000\u51fa\u66f4\u6362";
    t1 = J.get$onClick$x(change_close);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(B.onChangeClose$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    J.set$flex$x(change_prev.style, "1");
    J.set$flex$x(change_next.style, "1");
    J.set$flex$x(change_use_store.style, "1");
    J.set$flex$x(change_use_product.style, "1");
    J.set$flex$x(change_close.style, "1");
    $.change_view.appendChild(change_prev);
    $.change_view.appendChild(change_next);
    $.change_view.appendChild(change_use_store);
    $.change_view.appendChild(change_use_product);
    $.change_view.appendChild(change_close);
    J.set$display$x($.store_areas_view.style, "flex");
    B.divs_list_add1("store_areas", $.store_areas_view);
    $.bottom_height = "3.6em";
    $.top_height = J.get$height$x($.top_view.style);
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(B.onExport$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  ...
  gen_groups_products_view: function() {
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(B.onGroupProductsDisplay$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = $.groups_view;
    t1.className = "top";
    ...
    t1 = J.get$onClick$x(t1);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(B.onGroupProductDisplay$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    $.groups_products.forEach$1(0, new B.gen_groups_products_view_closure());
  },
  gen_store_product_view: function() {
    var t1, store_product_change_view, absract_view, count, i, line, j, e, plus_view, urgent_set_view, last_line_view, loop_e, clear_e;
    t1 = document.createElement("div", null);
    ...
    urgent_set_view = document.createElement("div", null);
    t1 = urgent_set_view.style;
    J.getInterceptor$x(t1).set$display(t1, "flex");
    C.CssStyleDeclaration_methods.set$flexFlow(t1, "row");
    C.CssStyleDeclaration_methods.set$flex(t1, "1");
    for (count = 0, j = 0; j < 10; ++j) {
      e = document.createElement("button", null);
      e.textContent = "\u6025" + C.JSInt_methods.toString$0(count);
      J.set$flex$x(e.style, "1");
      urgent_set_view.appendChild(e);
      ++count;
    }
    t1 = J.get$onClick$x(urgent_set_view);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(B.onUrgentSet$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    ...
    $.store_area_product_view.appendChild(urgent_set_view);
  ...
  gen_depot_product_view: function() {
    ...
    change_open = document.createElement("button", null);
    change_open.textContent = "\u66f4\u6362";
  ...
  processStoreString: function(store_string) {
    var store_areas_string, t1, areas_count, areas_columns_count, i, line_view, j, cell, area_no, area_name, row, column, area_view, spans, span1, span2, rows_string, rows_count, area_products_view, num1, num2, row_str, row_e, columns_str, columns_count, column_str, column_e, t2, pos, group_name, product_name, text, span10, span20, product_info, products, info, remain, set, t10, result, e;
        ...
        for (t1 = row > 0, column = 0; column < columns_count; ++column) {
          ...
          if (column > 0) {
            ...
            if (t10 == null ? t2 != null : t10 !== t2) {
              ...
              J.set$borderRightColor$x(result.style, "rgb(255,0,0)");
            }
          }
          if (t1) {
            t10 = column_e.getAttribute("group_name");
            ...
            e = t2.elementAt$1(t2, column);
            t2 = J.get$attributes$x(e)._html$_element.getAttribute("group_name");
            if (t10 == null ? t2 != null : t10 !== t2) {
              J.set$borderTopColor$x(column_e.style, "rgb(255,0,0)");
              J.set$borderBottomColor$x(e.style, "rgb(255,0,0)");
            }
          }
  ...
  processDepotString: function(depot_string) {
    var depot_areas_string, t1, areas_count, areas_columns_count, i, line_view, j, cell, area_no, area_name, row, column, area_display_view, spans, span1, span2, rows_string, rows_count, area_products_view, num1, num2, row_str, row_e, columns_str, columns_count, column_str, column_e, t2, pos, group_name, product_name, text, span10, span20, product_info, products, info, remain, set, t10, result, e;
  ...
  onDepot: [function(e) {
    ...
    if (t1.length === 1) {
      ...
      if (div == null ? t1 != null : div !== t1) {
        ...
        B.divs_list_add1("depot_areas", $.depot_areas_view);
      }
    }
  ...
  onExport: [function(e) {
    var t1, store_areas_string, areas_count, str1, area_no, area_name, table_string, t, area_products_view, rows_string, rows_count, row, row_str, row_e, columns_str, columns_count, column, t2, cell_e, column_str, pos, group_name, product_name, new_group_name, new_product_name, str, depot_areas_string, str2, old_groups_products, groups_count, str3, count, group, group_products, old_group_products, products_count, product, info, old_info, not_same;
        ...
        for (row = 0; row < rows_count; ++row) {
          ...
          for (t1 = J.getInterceptor$x(row_e), column = 0; column < columns_count; ++column) {
            ...
            if (group_name !== new_group_name || product_name !== new_product_name)
              str1 += C.JSString_methods.$add(C.JSString_methods.$add(C.JSString_methods.$add(";", area_name) + "," + C.JSInt_methods.toString$0(row) + "," + C.JSInt_methods.toString$0(column) + ",", new_group_name) + ",", new_product_name);
          }
        }
      }
      ...
      for (str2 = "", area_no = 0; area_no < areas_count; ++area_no) {
        ...
        for (row = 0; row < rows_count; ++row) {
          ...
          for (t1 = J.getInterceptor$x(row_e), column = 0; column < columns_count; ++column) {
            ...
            new_product_name = J.get$text$x(cell_e.firstChild);
            if (group_name !== new_group_name || product_name !== new_product_name)
              str2 += C.JSString_methods.$add(C.JSString_methods.$add(C.JSString_methods.$add(";", area_name) + "," + C.JSInt_methods.toString$0(row) + "," + C.JSInt_methods.toString$0(column) + ",", new_group_name) + ",", new_product_name);
          }
        }
      }
      str = (str2 !== "" ? str + C.JSString_methods.substring$1(str2, 1) : str) + "%";
      B.loadProduct();
  ...
  onClearData: [function(e) {
    ...
    if (t1 < 3)
      return;
    $.click_count = 0;
    H.interceptedTypeCast($.data_view.firstChild, "$isTextAreaElement").value = "";
    t1 = $.clear_kind;
    if (t1 === "export")
      ;
    else if (t1 === "urgent") {
      $.urgent_num = 0;
      B.set_view_set2($.urgent_num_e, 0);
      $.urgents.clear$0(0);
    } else if (t1 === "label") {
      $.label_num = 0;
      B.set_view_set2($.label_num_e, 0);
      $.labels.clear$0(0);
    }
    $.clear_kind = "";
    B.back("");
  }, "call$1", "onClearData$closure", 2, 0, 7],
  onUrgent: [function(e) {
    var t1, t2, text_area_view;
    t1 = {};
    if ($.divs_list.length === 1) {
      if ($.urgents._collection$_length === 0)
        return;
      t2 = $.click_count;
      if (typeof t2 !== "number")
        return t2.$add();
      ...
      $.click_count = 0;
      J.set$display$x($.data_view.style, "flex");
      B.divs_list_add1("urgent", $.data_view);
      text_area_view = H.interceptedTypeCast($.data_view.firstChild, "$isTextAreaElement");
      t1.str_0 = "";
      $.urgents.forEach$1(0, new B.onUrgent_closure(t1));
      text_area_view.value = t1.str_0;
      $.urgent_num_e.textContent = J.toString$0($.urgent_num);
    }
  ...
  onLabel: [function(e) {
    ...
    t1 = {};
    if ($.divs_list.length === 1) {
      if ($.labels._collection$_length === 0)
        return;
      t2 = $.click_count;
      if (typeof t2 !== "number")
        return t2.$add();
      ...
      $.click_count = 0;
      J.set$display$x($.data_view.style, "flex");
      B.divs_list_add1("label", $.data_view);
      text_area_view = H.interceptedTypeCast($.data_view.firstChild, "$isTextAreaElement");
      t1.str_0 = "";
      $.labels.forEach$1(0, new B.onLabel_closure(t1));
      text_area_view.value = t1.str_0;
      $.label_num_e.textContent = J.toString$0($.label_num);
    }
  }, "call$1", "onLabel$closure", 2, 0, 7],
  onUrgentSet: [function(e) {
    var num, t1, $name, t2;
    num = H.Primitives_parseInt(J.substring$1$s(H.interceptedTypeCast(J.get$target$x(e), "$isButtonElement").textContent, 1), null, null);
    t1 = $.group_name;
    if (t1 == null)
      return t1.$add();
    $name = C.JSString_methods.$add(t1 + ".", $.product_name);
    t1 = $.urgents.containsKey$1(0, $name);
    t2 = $.urgent_num;
    if (t1) {
      t1 = J.$sub$n(num, $.urgents.$index(0, $name));
      if (typeof t2 !== "number")
        return t2.$add();
      if (typeof t1 !== "number")
        return H.iae(t1);
    ...
    t2 = $.urgents;
    if (t1)
      t2.$indexSet(0, $name, num);
    else
      t2.remove$1(0, $name);
    B.set_view_set2($.urgent_num_e, $.urgent_num);
    B.back("");
  }, "call$1", "onUrgentSet$closure", 2, 0, 7],
  label_set: function(num) {
    var t1, $name, t2;
    if (J.trim$0$s(J.get$label$x($.product_info)) === "")
      return;
    t1 = $.group_name;
    if (t1 == null)
      return t1.$add();
    $name = C.JSString_methods.$add(t1 + ".", $.product_name);
    t1 = $.labels.containsKey$1(0, $name);
    t2 = $.label_num;
    if (t1) {
      t1 = J.$sub$n(num, $.labels.$index(0, $name));
      if (typeof t2 !== "number")
        return t2.$add();
      if (typeof t1 !== "number")
        return H.iae(t1);
    ...
    if (t1)
      ...
      t2.remove$1(0, $name);
    B.set_view_set2($.label_num_e, $.label_num);
  },
  onBack: [function(e) {
    B.back("");
  ...
  onStoreAreaProductsDisplay: [function(e) {
    ...
    if (str !== "") {
      ...
      t1 = H.interceptedTypeCast($.store_areas_products_view.querySelector(C.JSString_methods.$add("#", str)), "$isDivElement");
      $.store_area_products_view = t1;
      J.set$display$x(t1.style, "inline");
      J.set$top$x($.store_areas_products_view.style, "0em");
      J.set$top$x($.store_area_products_view.style, "0em");
      J.set$height$x($.store_areas_products_view.style, $.top_height);
      J.set$height$x($.store_area_products_view.style, $.top_height);
      B.divs_list_add2("store_area_products", $.store_areas_products_view, $.store_area_products_view);
    }
  }, "call$1", "onStoreAreaProductsDisplay$closure", 2, 0, 7],
  onDepotAreaProductsDisplay: [function(e) {
    ...
    if (str !== "") {
      ...
      t1 = H.interceptedTypeCast($.depot_areas_products_view.querySelector(C.JSString_methods.$add("#", str)), "$isDivElement");
      $.depot_area_products_view = t1;
      J.set$display$x(t1.style, "inline");
      J.set$top$x($.depot_areas_products_view.style, "0em");
      J.set$top$x($.depot_area_products_view.style, "0em");
      J.set$height$x($.depot_areas_products_view.style, $.top_height);
      J.set$height$x($.depot_area_products_view.style, $.top_height);
      B.divs_list_add2("depot_area_products", $.depot_areas_products_view, $.depot_area_products_view);
    }
  }, "call$1", "onDepotAreaProductsDisplay$closure", 2, 0, 7],
  onGroupProductsDisplay: [function(e) {
    ...
    if (str !== "")
      ...
      $.group_products_view = t1.firstChild;
    J.set$display$x($.groups_products_view.style, "inline");
    J.set$display$x(J.get$style$x($.group_products_view), "inline");
    J.set$top$x($.groups_products_view.style, "0em");
    J.set$top$x(J.get$style$x($.group_products_view), "0em");
    J.set$height$x($.groups_products_view.style, $.top_height);
    J.set$height$x(J.get$style$x($.group_products_view), $.top_height);
    B.divs_list_add2("group_products", $.groups_products_view, $.group_products_view);
  }, "call$1", "onGroupProductsDisplay$closure", 2, 0, 7],
  find_product_info_of_product: function(group_name, product_name) {
    var product_info, products, info;
    product_info = $.default_product_info;
    products = $.groups_products.$index(0, group_name);
    if (products != null) {
      info = J.$index$asx(products, product_name);
  ...
  find_product_info_of_elem: function(e) {
    var t1;
    $.group_name = J.get$attributes$x(e)._html$_element.getAttribute("group_name");
    t1 = J.get$text$x(e.firstChild);
    $.product_name = t1;
    $.product_info = B.find_product_info_of_product($.group_name, t1);
  },
  find_store_area_products_display0: function($name) {
    var t = C.JSString_methods.$add("*[name=\"", $name) + "\"]";
    return $.store_areas_view.querySelector(t);
  },
  find_depot_area_products_display0: function($name) {
    var t = C.JSString_methods.$add("*[name=\"", $name) + "\"]";
    return $.depot_areas_view.querySelector(t);
  },
  find_store_area: function() {
    var t1, str;
    t1 = $.store_area_product_display_view;
    if (t1 != null) {
      t1 = t1.parentElement.parentElement;
      $.store_area_products_view = t1;
    } else {
      str = C.JSString_methods.$add("*[group_name=\"", $.group_name) + "\"]";
      t1 = $.store_areas_products_view.querySelector(str).parentElement.parentElement;
      $.store_area_products_view = t1;
    }
    $.store_area_products_display_view = B.find_store_area_products_display0(t1.id);
  },
  find_group: function() {
    var t1, n, t2, t3;
    ...
    if (t1 != null)
      ...
      for (t1 = C.NodeList_methods.get$iterator($.groups_products_view.childNodes); t1.moveNext$0();) {
        n = t1._html$_current;
        t2 = J.get$id$x(n);
        t3 = $.group_name;
        if (t2 == null ? t3 == null : t2 === t3) {
          $.group_products_view = n;
          break;
        }
      }
  },
  find_depot_area_product_display: function() {
    if ($.product_info.get$depot() != null) {
      var t1 = $.product_info.get$depot();
      $.depot_area_product_display_view = t1;
      t1 = t1.parentElement.parentElement;
      $.depot_area_products_view = t1;
      $.depot_area_products_display_view = B.find_depot_area_products_display0(t1.id);
    } else {
  ...
  display_store_area_product: function() {
    ...
    J.set$text$x($.store_area_product_view.firstChild, text);
  ...
  onStoreAreaProductDisplay: [function(e) {
    ...
    if ($.state === 1) {
      B.change();
      if (J.get$last$ax($.divs_list).get$mark() === "change_use_store")
        B.change_next();
    } else if (!J.$eq($.product_name, "")) {
      $.space_click_count = 0;
  ...
  change0: function(e, group_name, product_name) {
    var change_group_name, change_product_name, change_product_info, product_info, t, product_display_views, t1, product_display_view, t2, change_area_products_display_view, row_prev_e, row_next_e, i, column_prev_e, column_next_e, old_remain, old_set, remain, set, remain_set_update, set_update, spans, span1, span2;
    change_group_name = J.get$attributes$x(e)._html$_element.getAttribute("group_name");
    change_product_name = J.get$text$x(e.firstChild);
    change_product_info = B.find_product_info_of_product(change_group_name, change_product_name);
    if (change_product_info != null && !J.$eq(change_product_info, $.default_product_info))
      if ($.change_kind === "store")
        change_product_info.set$store(null);
      else
        change_product_info.set$depot(null);
    product_info = B.find_product_info_of_product(group_name, product_name);
    e.setAttribute("group_name", group_name);
    J.set$text$x(e.firstChild, product_name);
    if (!J.$eq(product_name, ""))
      if ($.change_kind === "store") {
        if (product_info != null && !J.$eq(product_info, $.default_product_info))
          product_info.set$store(e);
      } else if (product_info != null && !J.$eq(product_info, $.default_product_info))
        product_info.set$depot(e);
    if (change_product_name !== "")
      if ($.change_kind === "store") {
        ...
        for (t1 = product_display_views.get$iterator(product_display_views); t1.moveNext$0();) {
          ...
          if (t2 == null ? change_product_name == null : t2 === change_product_name) {
            change_product_info.store = product_display_view;
            break;
          }
        }
      } else {
        ...
        for (t1 = product_display_views.get$iterator(product_display_views); t1.moveNext$0();) {
          ...
          t2 = J.get$text$x(J.get$firstChild$x(product_display_view));
          if (t2 == null ? change_product_name == null : t2 === change_product_name) {
            change_product_info.depot = product_display_view;
            break;
          }
        }
      }
    B.set_product_display_view0(e, product_info);
    t1 = $.change_kind;
    t2 = e.parentElement;
    change_area_products_display_view = t1 === "store" ? B.find_store_area_products_display0(t2.parentElement.id) : B.find_depot_area_products_display0(t2.parentElement.id);
    row_prev_e = e.previousElementSibling;
    if (row_prev_e != null) {
      t2 = row_prev_e.getAttribute("group_name");
      t1 = e.style;
      if (group_name == null ? t2 != null : group_name !== t2) {
        J.set$borderLeftColor$x(t1, "rgb(255,0,0)");
        J.set$borderRightColor$x(row_prev_e.style, "rgb(255,0,0)");
      } else {
        J.set$borderLeftColor$x(t1, "");
        J.set$borderRightColor$x(row_prev_e.style, "");
      }
    }
    row_next_e = e.nextElementSibling;
    if (row_next_e != null) {
      t2 = row_next_e.getAttribute("group_name");
      t1 = e.style;
      if (group_name == null ? t2 != null : group_name !== t2) {
        J.set$borderRightColor$x(t1, "rgb(255,0,0)");
        J.set$borderLeftColor$x(row_next_e.style, "rgb(255,0,0)");
      } else {
        J.set$borderRightColor$x(t1, "");
        J.set$borderLeftColor$x(row_next_e.style, "");
      }
    }
    t1 = e.parentElement;
    if (t1.previousElementSibling != null) {
      ...
      t1 = new W._ChildNodeListLazy(t1);
      i = t1.indexOf$1(t1, e);
      t1 = e.parentElement.previousElementSibling;
      t1.toString;
      t1 = new W._ChildNodeListLazy(t1);
      ...
      t1 = e.style;
      if (group_name == null ? t2 != null : group_name !== t2) {
        J.set$borderTopColor$x(t1, "rgb(255,0,0)");
        J.set$borderBottomColor$x(column_prev_e.style, "rgb(255,0,0)");
      } else {
        J.set$borderTopColor$x(t1, "");
        J.set$borderBottomColor$x(column_prev_e.style, "");
      }
    }
    t1 = e.parentElement;
    if (t1.nextElementSibling != null) {
      ...
      t1 = new W._ChildNodeListLazy(t1);
      i = t1.indexOf$1(t1, e);
      t1 = e.parentElement.nextElementSibling;
      t1.toString;
      t1 = new W._ChildNodeListLazy(t1);
      ...
      if (group_name == null ? t2 != null : group_name !== t2) {
        ...
        J.set$borderTopColor$x(column_next_e.style, "rgb(255,0,0)");
      } else {
        J.set$borderBottomColor$x(t1, "");
        J.set$borderTopColor$x(column_next_e.style, "");
      }
    }
    old_remain = change_product_info.get$remain();
    old_set = change_product_info.set;
    ...
    spans = W._FrozenElementList$_wrap(change_area_products_display_view.querySelectorAll("span"), null);
    span1 = spans.elementAt$1(spans, 0);
    span2 = spans.elementAt$1(spans, 1);
  ...
  change: function() {
    ...
    if (J.get$last$ax($.divs_list).get$mark() === "group_products")
      if ($.change_kind === "store")
        ...
        B.back("depot_area_products");
  },
  onGroupProductDisplay: [function(e) {
    var t1;
    if ($.state === 1) {
      t1 = J.getInterceptor$x(e);
      if (!!J.getInterceptor(t1.get$target(e)).$isDivElement)
  ...
  }, "call$1", "onGroupProductDisplay$closure", 2, 0, 7],
  onDepotChangeOpen: [function(e) {
    var prev, e1, e2, l, t1;
    $.change_area_products_display_view = $.depot_area_products_display_view;
    $.change_areas_products_view = $.depot_areas_products_view;
    ...
    $.change_product_name = $.product_name;
    $.change_product_info = $.product_info;
    B.back("");
    prev = J.get$previousElementSibling$x($.change_area_product_display_view);
    if (prev != null && prev.getAttribute("group_name") !== "")
      B.find_product_info_of_elem(prev);
    else
      B.find_product_info_of_elem($.change_area_product_display_view);
    if ($.change_kind === "store")
      ;
    else {
      $.store_area_product_display_view = $.product_info.get$store();
      ...
      $.group_product_display_view = $.product_info.get$group();
      B.find_group();
      if ($.store_area_products_view != null || $.group_products_view != null) {
        B.back("");
        J.set$display$x($.change_areas_products_view.style, "inline");
        J.set$display$x($.change_area_products_view.style, "inline");
        J.set$height$x($.change_areas_products_view.style, J.get$height$x(J.get$style$x($.change_area_product_display_view)));
        J.set$height$x($.change_area_products_view.style, J.get$height$x(J.get$style$x($.change_area_product_display_view)));
        J.scrollIntoView$0$x($.change_area_product_display_view);
        J.set$display$x($.bottom_view.style, "none");
        J.set$display$x($.change_view.style, "flex");
        e1 = $.store_areas_products_view;
        e2 = $.store_area_products_view;
        if (e2 == null) {
          e1 = $.group_products_view;
          e2 = $.groups_products_view;
        }
        J.set$display$x(J.get$style$x(e1), "inline");
        J.set$display$x(e2.style, "inline");
        J.set$top$x(e1.style, J.get$height$x($.change_areas_products_view.style));
        J.set$bottom$x(e1.style, $.bottom_height);
        J.set$top$x(e2.style, J.get$height$x($.change_areas_products_view.style));
        J.set$bottom$x(e2.style, $.bottom_height);
        l = H.setRuntimeTypeInfo([], [W.DivElement]);
        l.push($.change_areas_products_view);
        l.push($.change_area_products_view);
        l.push($.change_view);
        l.push(e1);
        l.push(e2);
        if ($.store_area_products_view != null) {
          t1 = $.store_area_product_display_view;
          if (t1 != null)
            J.scrollIntoView$0$x(t1);
          B.divs_list_add("change_use_store", l);
        } else
          B.divs_list_add("change_use_product", l);
      } else {
        B.find_product_info_of_elem($.change_area_product_display_view);
        $.store_area_product_display_view = $.product_info.get$store();
        B.find_store_area();
  ...
  }, "call$1", "onDepotChangeOpen$closure", 2, 0, 7],
  onChangePrev: [function(e) {
    var prev_e = J.get$previousElementSibling$x($.change_area_product_display_view);
    if (prev_e != null)
      B.change_set(prev_e);
  }, "call$1", "onChangePrev$closure", 2, 0, 7],
  change_set: function(e) {
    var t1 = $.change_area_product_display_view;
    if (t1 != null) {
      J.get$classes$x(t1).remove$1(0, "has_outline");
      J.get$classes$x($.change_area_product_display_view).add$1(0, "has_no_outline");
    }
    $.change_area_product_display_view = e;
    J.get$classes$x(e).add$1(0, "has_outline");
    B.find_product_info_of_elem($.change_area_product_display_view);
    $.change_group_name = $.group_name;
    $.change_product_name = $.product_name;
    $.change_product_info = $.product_info;
  ...
  change_next: function() {
    var next_e = J.get$nextElementSibling$x($.change_area_product_display_view);
    if (next_e != null) {
      J.scrollIntoView$0$x(next_e);
      B.change_set(next_e);
    }
  },
  onChangeNext: [function(e) {
    B.change_next();
  }, "call$1", "onChangeNext$closure", 2, 0, 7],
  onChangeUseProduct: [function(e) {
    var div_list;
    if (J.get$last$ax($.divs_list).get$mark() !== "change_use_product") {
      J.set$display$x($.store_areas_products_view.style, "none");
      J.set$display$x($.store_area_products_view.style, "none");
      div_list = J.get$last$ax($.divs_list).get$div_list();
      if (0 >= div_list.length)
        return H.ioore(div_list, 0);
      div_list.pop();
      if (0 >= div_list.length)
        return H.ioore(div_list, 0);
      div_list.pop();
      J.set$display$x($.groups_products_view.style, "inline");
      J.set$display$x(J.get$style$x($.group_products_view), "inline");
      J.set$zIndex$x($.groups_products_view.style, J.toString$0($.z_index));
      J.set$zIndex$x(J.get$style$x($.group_products_view), J.toString$0($.z_index));
      J.set$top$x($.groups_products_view.style, J.get$height$x(J.get$style$x($.change_area_product_display_view)));
      J.set$bottom$x($.groups_products_view.style, $.bottom_height);
      J.set$top$x(J.get$style$x($.group_products_view), J.get$height$x(J.get$style$x($.change_area_product_display_view)));
      J.set$bottom$x(J.get$style$x($.group_products_view), $.bottom_height);
      div_list.push($.groups_products_view);
      div_list.push($.group_products_view);
      J.get$last$ax($.divs_list).set$mark("change_use_product");
    }
  }, "call$1", "onChangeUseProduct$closure", 2, 0, 7],
  onChangeUseStore: [function(e) {
    var div_list, t1;
    if (J.get$last$ax($.divs_list).get$mark() !== "change_use_store") {
      if ($.store_area_products_view == null)
        return;
      J.set$display$x($.groups_products_view.style, "none");
      J.set$display$x(J.get$style$x($.group_products_view), "none");
      div_list = J.get$last$ax($.divs_list).get$div_list();
      if (0 >= div_list.length)
        return H.ioore(div_list, 0);
      div_list.pop();
      ...
      div_list.pop();
      J.set$display$x($.store_areas_products_view.style, "inline");
      J.set$display$x($.store_area_products_view.style, "inline");
      J.set$top$x($.store_areas_products_view.style, J.get$height$x(J.get$style$x($.change_area_product_display_view)));
      J.set$top$x($.store_area_products_view.style, J.get$height$x(J.get$style$x($.change_area_product_display_view)));
      J.set$bottom$x($.store_areas_products_view.style, $.bottom_height);
      J.set$bottom$x($.store_area_products_view.style, $.bottom_height);
      J.set$zIndex$x($.store_areas_products_view.style, J.toString$0($.z_index));
      J.set$zIndex$x($.store_area_products_view.style, J.toString$0($.z_index));
      t1 = $.store_area_product_display_view;
      if (t1 != null)
        J.scrollIntoView$0$x(t1);
      div_list.push($.store_areas_products_view);
      div_list.push($.store_area_products_view);
      J.get$last$ax($.divs_list).set$mark("change_use_store");
    }
  }, "call$1", "onChangeUseStore$closure", 2, 0, 7],
  onChangeClose: [function(e) {
    var l;
    B.back("");
    J.get$classes$x($.change_area_product_display_view).remove$1(0, "has_outline");
    J.get$classes$x($.change_area_product_display_view).add$1(0, "has_no_outline");
    l = H.setRuntimeTypeInfo([], [W.DivElement]);
    l.push($.change_areas_products_view);
    l.push($.change_area_products_view);
    B.divs_list_add("depot_area_products", l);
    J.set$display$x($.change_areas_products_view.style, "inline");
    J.set$display$x($.change_area_products_view.style, "inline");
    J.set$top$x($.change_areas_products_view.style, "0em");
    J.set$top$x($.change_area_products_view.style, "0em");
    J.set$height$x($.change_areas_products_view.style, $.top_height);
    J.set$height$x($.change_area_products_view.style, $.top_height);
    J.set$display$x($.bottom_view.style, "flex");
    $.store_area_products_display_view = null;
    $.store_area_products_view = null;
    $.store_area_product_display_view = null;
    $.depot_area_products_display_view = $.change_area_products_display_view;
    ...
    $.product_info = $.default_product_info;
    $.state = 0;
  }, "call$1", "onChangeClose$closure", 2, 0, 7],
  area_product_change: function() {
    ...
    if (prev_e != null)
      B.find_product_info_of_elem(prev_e);
    else
      B.find_product_info_of_elem($.change_area_product_display_view);
    $.group_product_display_view = $.product_info.get$group();
    B.find_group();
    if ($.group_products_view != null) {
      J.set$display$x($.groups_products_view.style, "inline");
      J.set$display$x(J.get$style$x($.group_products_view), "inline");
      B.divs_list_add2("group_products", $.groups_products_view, $.group_products_view);
    }
  ...
  store_area_product_change: function() {
    ...
    $.change_area_products_display_view = $.store_area_products_display_view;
  ...
  set_product_display_view0: function(e, product_info) {
  ...
  set_product_set: function(remain, set) {
    var old_set, old_remain_set, remain_set_update, set_update, t1, area_spans, area_set_span, area_remain_set_span, area_set, area_remain_set;
    if (remain === "")
      remain = $.product_info.get$remain();
    if (J.$eq(set, -1))
    ...
    $.product_info.get$remain();
    $.product_info.set$set(set);
    $.product_info.set$remain(remain);
    remain_set_update = J.$sub$n(J.$eq(remain, "0") ? 0 : set, old_remain_set);
    set_update = J.$sub$n(set, old_set);
    t1 = $.store_area_product_display_view;
    if (t1 != null)
      B.set_product_display_view0(t1, $.product_info);
  ...
  onClearAll: [function(e) {
    ...
    for (; next != null; cur = next, next = next0) {
      ...
      if (J.get$text$x(next.firstChild) !== "") {
        ...
        if (J.get$text$x(span1) !== "0" && J.get$text$x(span2) !== "0") {
          $.depot_area_product_display_view = next;
          $.group_name = J.get$attributes$x(next)._html$_element.getAttribute("group_name");
          t1 = J.get$text$x(next.firstChild);
          $.product_name = t1;
          t1 = B.find_product_info_of_product($.group_name, t1);
          $.product_info = t1;
          $.store_area_product_display_view = t1.get$store();
          B.find_store_area();
          $.group_product_display_view = $.product_info.get$group();
          B.find_group();
          B.label_set($.product_info.get$set());
  ...
  hide_last: function() {
    ...
    l = last_divs.get$div_list();
    for (t1 = new H.ListIterator(l, l.length, 0, null); t1.moveNext$0();)
      J.set$display$x(J.get$style$x(t1._current), "none");
    switch (last_divs.mark) {
      case "groups":
        if ($.state === 1) {
          $.group_name = $.change_group_name;
          $.product_name = $.change_product_name;
          t1 = $.change_product_info;
          $.product_info = t1;
          $.group_product_display_view = t1.get$group();
          B.find_group();
          $.state = 0;
        }
        break;
      case "store_area_products":
        $.store_area_products_display_view = null;
        $.store_area_products_view = null;
        break;
      case "depot_area_products":
        $.depot_area_products_display_view = null;
        $.depot_area_products_view = null;
        break;
      case "group_products":
  ...
  divs_list_add2: function(m, e1, e2) {
    ...
    J.set$zIndex$x(J.get$style$x(e2), J.toString$0($.z_index));
    l = H.setRuntimeTypeInfo([], [W.DivElement]);
    l.push(e1);
    l.push(e2);
    $.divs_list.push(B.Divs$(m, l));
  ...
  Divs: {
    "^": "Object;z,mark@,div_list<",
    Divs$2: function(m, l) {
      this.mark = m;
      this.div_list = l;
      this.z = J.toString$0($.z_index);
    },
    static: {Divs$: function(m, l) {
        var t1 = new B.Divs(null, null, null);
        t1.Divs$2(m, l);
        return t1;
      }}
  },
    ...
    call$2: function(group_name, group_products) {
      ...
      for (cur = 0, i = 0; i < 7; ++i) {
        ...
        for (j = 0; j < columns_count; ++j) {
          ...
          t3 = J.getInterceptor(product_name);
          if (!t3.$eq(product_name, ""))
            product_info.set$group(cell);
          remain = product_info.get$remain();
          if (!t3.$eq(product_name, ""))
  ...
  local__closure1: {
    ...
    call$2: function(k, v) {
      ...
      if (!t1.$eq(k, "")) {
        ...
        t2.product_text_2 = product_text;
        t2.product_text_2 = product_text + C.JSNull_methods.toString$0(v.comment);
      }
    }
  },
  local_closure0: {
  ...
  local___closure0: {
    ...
    call$1: function(cell) {
      ...
      t1 = this.box_0;
      t1.line_text_0 += ",";
      t2 = cell.getAttribute("group_name");
      t3 = t1.line_text_0;
      if (t2 === "")
        t1.line_text_0 = t3 + "-";
      else {
        ...
        if (t2 == null)
          return t2.$add();
        t1.line_text_0 = t3 + C.JSString_methods.$add(t2 + ".", J.get$text$x(cell.firstChild));
      }
    }
  },
  local_closure1: {
  ...
  onUrgent_closure: {
    "^": "Closure:9;box_0",
    call$2: function($name, num) {
      var t1 = this.box_0;
      t1.str_0 = C.JSString_methods.$add(t1.str_0, J.$add$ns(J.$add$ns(J.$add$ns($name, "    \u6025"), J.toString$0(num)), "\n"));
    }
  },
  onLabel_closure: {
    "^": "Closure:9;box_0",
    call$2: function($name, num) {
      var t1 = this.box_0;
      t1.str_0 = C.JSString_methods.$add(t1.str_0, J.$add$ns(J.$add$ns(J.$add$ns($name, "    "), J.toString$0(num)), "\n"));
    }
  },
  onNoLabelRemainZero_closure: {
    ...
    call$2: function($name, info) {
      $.product_name = $name;
      $.product_info = info;
      $.store_area_product_display_view = info.get$store();
      B.find_store_area();
      B.find_depot_area_product_display();
      $.group_product_display_view = $.product_info.get$group();
      B.find_group();
...
J.set$borderBottomColor$x = function(receiver, value) {
  return J.getInterceptor$x(receiver).set$borderBottomColor(receiver, value);
};
J.set$borderLeftColor$x = function(receiver, value) {
  return J.getInterceptor$x(receiver).set$borderLeftColor(receiver, value);
};
J.set$borderRightColor$x = function(receiver, value) {
  return J.getInterceptor$x(receiver).set$borderRightColor(receiver, value);
};
...
J.set$flex$x = function(receiver, value) {
  return J.getInterceptor$x(receiver).set$flex(receiver, value);
};
J.set$flexFlow$x = function(receiver, value) {
  return J.getInterceptor$x(receiver).set$flexFlow(receiver, value);
};
...
$.state = null;
$.change_kind = null;
$.change_area_products_display_view = null;
$.change_areas_products_view = null;
$.change_area_products_view = null;
$.change_area_product_display_view = null;
$.change_group_name = null;
$.change_product_name = null;
$.change_product_info = null;
$.store_num1 = null;
$.store_num2 = null;
$.depot_num1 = null;
$.depot_num2 = null;
